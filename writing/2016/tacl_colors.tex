...
\begin{tabular}{lrrr|rrr}
  ...
  \% Superlatives & 0.02 & 0.06 & 0.16 & 0.05 & 0.10 & 0.17 \\ 
   \hline
\end{tabular}
\caption{Corpus statistics and statistics of samples from $\Speaker_1$ (rates per utterance). \todocheck{todo: check human words rates, put errors in?}} \label{table:metrics}
\label{table:metrics}
\end{table*}
