...
\end{tabular}
\label{table:metrics}
\todo[inline]{todo: put errors in, include wordnet level of informativity}
\end{table*}
...
\begin{tabular}{lrrrrrr}
  ...
  $\Listener_2$ & \best{84.11} & \best{84.82} & \todocheck{...} & \best{1.49} & \best{1.45} & \todocheck{...} \\
  \hline
...
utterances of human speakers (\tabref{table:speakerVsListener}, $\Speaker_h$ columns).
