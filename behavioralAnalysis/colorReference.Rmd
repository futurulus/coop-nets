...
write_csv(combined_human, path = "filteredCorpus.csv")
```
...
Why are some of the unique worker ids in the filtered corpus NAs? Because there was a small number of turkers that completed the task but did not submit their HIT. We're including this data even though we don't have complete subject info. 
